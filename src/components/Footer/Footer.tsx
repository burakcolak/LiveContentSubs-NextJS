        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            ...
            <div className="py-4 pr-16">
              Twitch viewer bot is a web software that aims to increase the
              discovery and visibility of talented and entry-level streamers who
              try to exist on Twitch and make great efforts to develop their
              channel.❤️
            </div>
          </div>
